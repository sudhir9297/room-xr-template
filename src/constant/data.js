export const productData = {
  ...
  name: "Sofa",
  description:
    "You can't miss Billie when you step into a room. Its chubby shape and wide armrests are completely on trend. The sofa is justas stylish from the back as it is from the front, which means it can easily stand almost anywhere. In addition to its fantastic appearance, it is very comfortable to sit in and is therefore an excellent choice as a sofa for evenings in front of the TV. This variant also comes with a divan for extra relaxation.",
  dimensions: {
    width: 200,
    height: 85,
    depth: 90,
  ...
  // details: {
  //   product_type:
  //     "A classic smaller-sized chest of drawers in solid wood, with a traditional look and modern function. Quiet, smooth-running drawers makes it easy to organise your things. Psst! Please attach to the wall.",
  //   availability: "In stock. Immediate delivery",
  //   shipping: "Free shipping",
  //   payment_options: "Buy now. Pay in 3 months, interest-free",
  // },
